...
<html lang="en">
 ...
 <section id="menu">
  ...
  <section id="aa-catg-head-banner">
   <img style="width: 1920px;height: 300px" src="<?php echo base_url('upload/KatBarang/'.$produk->gambar_kat); ?>" alt="fashion img">
     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><?= $produk->nama_barang ?></li>
        </ol>
      </div>
     </div>
   </div>
                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="<?php echo base_url('upload/Barang/'.$produk->gambar); ?>" class="simpleLens-lens-image"><img src="<?php echo base_url('upload/Barang/'.$produk->gambar); ?>" class="simpleLens-big-image"></a></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-price-block">
                      <span class="aa-product-view-price">Rp. <?= number_format($produk->harga_jual_satuan)?></span>
