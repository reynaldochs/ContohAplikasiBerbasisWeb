            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                ...
                <div class="aa-cartbox-summary">
                  ...
                  <a class="aa-cartbox-checkout aa-primary-btn" href="<?= site_url('user/cart/checkout') ?>">Checkout</a>
                </div>
              </div>
              <!-- / cart box -->
      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              <div class="seq-model">
                <img data-seq src="<?php echo base_url('upload/KatBarang/'.$data->gambar); ?>" alt="Men slide img"/>
              </div>
              <div class="seq-title">               
                <h2 data-seq><?= $data->nama ?></h2>                
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            ...
            <?php
                    foreach($kategori as $data){ ?>
                    <li class=""><a href="#men" data-toggle="tab"><?= $data->nama ?></a></li>
                  <?php } ?>
                  </ul> -->
                  <br>
                  <center><h2>Our Hot & Popular Products</h2></center>
                  <br>
                  <!-- Tab panes -->
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#">
                              <img style="width: 250px;height: 300px;"  src="<?php echo base_url('upload/Barang/'.$data->gambar); ?>" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn" href="<?= site_url()?>/user/cart/addcart/<?= $data->id?>"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                              <figcaption>
                              <h4 class="aa-product-title"><a href="<?= site_url()?>/user/home/detail_product/<?= $data->id?>"><?= $data->nama_barang ?></a></h4>
                              <span class="aa-product-price">Rp. <?= number_format($data->harga_jual_satuan) ?></span>
                          ...
                          <!-- product badge -->
                          <?php if($data->is_popular==1){ ?><span class="aa-badge aa-sale" href="#">POPULAR!</span>
                        <?php } ?>
                        </li>
                        <!-- start single product item -->
                      <?php } ?>
                      </ul>
                      <a class="aa-browse-btn" href="<?= site_url() ?>/user/home/product">Browse all Product <span class="fa fa-long-arrow-right"></span></a>
                    </div>
                                ...
                                <div class="simpleLens-gallery-container" id="demo-1">
                                  <div class="simpleLens-container">
                                      <div class="simpleLens-big-image-container">
                                          <a class="simpleLens-lens-image" data-lens-image="<?php echo base_url('upload/Barang/'.$data->gambar); ?>">
                                              <img src="<?php echo base_url('upload/Barang/'.$data->gambar); ?>" class="simpleLens-big-image">
                                          </a>
                                      </div>
                                  </div>
                                </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <div class="aa-product-view-content">
                                ...
                                <div class="aa-price-block">
                                  <span class="aa-product-view-price">Rp. <?=number_format($data->harga_jual_satuan)?></span>
                                  <p class="aa-product-avilability">Avilability: <span><?= $data->stok>0 ? "In Stock" : "Out Of Stock"?></span></p>
                                </div>
